...
<head>
	...
	<title>ระบบตลาดกลางอาหารสัตว์เลี้ยง | เข้าสู่ระบบ</title>
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-v2" data-pageload-addclass="animated fadeIn">
			...
			<div class="login-header">
				<div class="brand">
					<img src="dist/img/logo/icon.png" style="width: 40px; height: 40px;"> <b>เข้าสู่ระบบ</b> สมาชิก
			...
			<div class="login-content">
				<form action="process_login.php" method="POST" class="margin-bottom-0" data-parsley-validate="true">
					<div class="form-group m-b-20">
						<input type="text" class="form-control form-control-lg" name="user_username" placeholder="ชื่อผู้ใช้" data-parsley-required="true" value="user01" />
					</div>
					<div class="form-group m-b-20">
						<input type="password" class="form-control form-control-lg" name="user_password" placeholder="รหัสผ่าน" data-parsley-required="true"  value="123456" />
					</div>
					<div class="login-buttons">
						<button type="submit" class="btn btn-success btn-block btn-lg">เข้าสู่ระบบ</button>
					</div>
					<div class="m-t-20">
						ถ้ายังไม่เป็นสมาชิก? คลิ๊ก <a href="register.php">ที่นี่</a> เพื่อลงทะเบียน.
					</div>
				</form>
			</div>
			<!-- end login-content -->

...
<head>
	...
	<title>ระบบตลาดกลางอาหารสัตว์เลี้ยง | ผู้ดูแลระบบ</title>
		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
					...
					<li class="nav-profile">
						<a href="javascript:;" data-toggle="nav-profile">
							...
							<div class="info text-center">
								...
								<small>ผู้ดูแลระบบ<br/>ระบบตลาดกลางอาหารสัตว์เลี้ยง</small>
							</div>
						</a>
					</li>
					<!-- <li>
				...
				<ul class="nav">
					...
					<li class="<?php echo (in_array(explode(".php", basename($_SERVER['REQUEST_URI']))[0], ["user", "user.view"]))? "active": ""; ?>">
						<a href="user.php">
							<i class="icon-user"></i> 
							<span>จัดการสมาชิก</span>
						</a>
					</li>
					<li class="<?php echo (in_array(explode(".php", basename($_SERVER['REQUEST_URI']))[0], ["seller", "seller.view"]))? "active": ""; ?>">
						<a href="seller.php">
							<i class="icon-home"></i> 

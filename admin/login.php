	...
	<div id="page-container" class="fade">
		...
		<div class="login login-v2" data-pageload-addclass="animated fadeIn">
			...
			<div class="login-header">
				<div class="brand">
					<img src="../dist/img/logo/icon.png" style="width: 40px; height: 40px;"> <b>เข้าสู่ระบบ</b> ผู้ดูแลระบบ
			...
			<div class="login-content">
				<form action="process_login.php" method="POST" class="margin-bottom-0" data-parsley-validate="true">
					<div class="form-group m-b-20">
						<input type="text" class="form-control form-control-lg" name="admin_username" placeholder="ชื่อผู้ใช้" data-parsley-required="true" value="1" />
					</div>
					<div class="form-group m-b-20">
						<input type="password" class="form-control form-control-lg" name="admin_password" placeholder="รหัสผ่าน" data-parsley-required="true" value="1" />
					</div>

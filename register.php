...
<head>
	...
	<title>ระบบตลาดกลางอาหารสัตว์เลี้ยง | สมัครสมาชิก</title>
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-v2" data-pageload-addclass="animated fadeIn">
			...
			<div class="login-header">
				<div class="brand">
					<img src="dist/img/logo/icon.png" style="width: 40px; height: 40px;"> <b>ลงทะเบียน</b> สมาชิก
			...
			<div class="login-content">
				<form action="process_register.php" method="POST" class="margin-bottom-0" data-parsley-validate="true">
					...
					<!-- <div class="form-group m-b-20">
						<input type="password" class="form-control form-control-lg" placeholder="รหัสผ่าน" required />
					</div> -->
